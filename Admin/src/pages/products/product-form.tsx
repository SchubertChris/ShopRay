        ...
        <div className="form-col">
          ...
          <div className="form-section">
            ...
            <div className="form-field">
              ...
              <textarea className="form-textarea" value={form.highlights} onChange={set('highlights')} rows={4}
                placeholder={'100 % natürliches Material\nHandmade in Germany\nPlastikfrei verpackt'} />
              <p className="form-hint">Ein Vorteil pro Zeile — erscheinen direkt unter dem Preis als Aufzählung.</p>
            </div>
          ...
          <div className="form-section">
            ...
            <p className="form-section__desc">
              Links zu externen Händlern (Manufactum, Connox, Amazon etc.) — erscheinen im Bereich
              "Erhältlich bei" auf der Produktdetailseite.
            </p>
